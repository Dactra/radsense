...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
   ...
   $query = mysqli_query($conn,"SELECT DISTINCT groupname FROM radgroupreply");
    $service = mysqli_num_rows($query);

    $query2 = mysqli_query($conn,"SELECT DISTINCT username FROM radcheck");
     $user = mysqli_num_rows($query2);

     $query3 = mysqli_query($conn,"SELECT DISTINCT nasname FROM nas");
      $nas = mysqli_num_rows($query3);
...
<body>
                    ...
                    <ul class="top-icons-agileits-w3layouts float-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu drop-3">
                                ...
                                <a href="admin.php" class="dropdown-item mt-3">
                                    <h4>
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <div class="stat-grid p-3 d-flex align-items-center justify-content-between bg-primary">
                            <div class="s-l">
                                <h5>Current User</h5>
                                <p class="paragraph-agileits-w3layouts text-white"><? echo $_SESSION["username"]; ?></p>
                            </div>
                            <div class="s-r">
                                <h6>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-success">
                            <div class="s-l">
                                <h5>NAS Clients</h5>
                                <p class="paragraph-agileits-w3layouts">Total NAS</p>
                            </div>
                            <div class="s-r">
                                <h6><? echo $nas; ?>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-danger">
                            <div class="s-l">
                                <h5>Services</h5>
                                <p class="paragraph-agileits-w3layouts">Total Services</p>
                            </div>
                            <div class="s-r">
                                <h6><?php echo "$service";?>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-warning">
                            <div class="s-l">
                                <h5>Users</h5>
                                <p class="paragraph-agileits-w3layouts">Total Users</p>
                            </div>
                            <div class="s-r">
                                <h6><?php echo "$user";?>
                                    <i class="fas fa-users"></i>
                    ...
                    <div class="outer-w3-agile col-xl ml-xl-3 mt-xl-0 mt-3">
                        <h4 class="tittle-w3-agileits mb-4">Your User Base</h4>
                        <div id="chartdiv"></div>
                    </div>
                    <!--// Pie-chart -->
                </div>
    ...
    <script>
        ...
        var chartData = [
          ...
          <?php
          $query = mysqli_query($conn,"SELECT COUNT(username), groupname FROM radusergroup GROUP BY groupname");
          while($row = mysqli_fetch_assoc($query))
          {
          $ucount = $row['COUNT(username)'];
          $gname = $row['groupname'];

          ?>
                {
                  country: "<?php echo"$gname";?>",
                value: <?php echo"$ucount";?>
            },
          <?php }?>
        ];
