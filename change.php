            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu3">
                        ...
                        <li>
                            <a href="service.html">Create Service</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div id="content">
                     ...
                     if(empty($username) || empty($password) || empty($newpassword))
          {
              echo "You did not fill out the required fields.";
                  ...
                  $sql = "SELECT value FROM radcheck WHERE username='$username' AND attribute='MD5-Password'";
                  ...
                  if (mysqli_num_rows($result) < 1) {
                    ...
                    echo "          <!-- main-heading -->
                              ...
                              <div>
                                  ...
                                  <!-- Error Page Info -->
                                  <div>
                                      <p>You provided incorrect credentials!</p>
                                  </div>
                                  <!--// Error Page Info -->
                  ...
                  else
                  {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                       ...
                       $passworddb=$row[value];
                       $oldhashed=MD5($password);


                      if($passworddb==$oldhashed)
                      {

                    $sql2 = "UPDATE radcheck SET value='$newhashed' WHERE username='$username' AND attribute='MD5-Password'";
