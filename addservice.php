            ...
            <?php
             ...
             $service = $_POST['service'];
              $upload = $_POST['upload'];
               ...
               if(empty($service) || empty($upload) || empty($download) || empty($quota))
    {
        echo "You did not fill out the required fields.";
    }

     else {
       // Get the html form data and convert the speed and data limits into bytes by multiply with 1000
         $k = 1000;
         $kupload = $upload*$k;
         $kdownload = $download*$k;
         $kquota = $quota*$k;

            $sql = "SELECT * FROM radgroupreply WHERE groupname='$service'";
            $result = mysqli_query($conn, $sql);

            if (mysqli_num_rows($result) < 1) {


            $sql1 = "INSERT INTO radgroupreply (id ,groupname ,attribute ,op ,value )
            VALUES (NULL , '$service', 'pfSense-Bandwidth-Max-Down', ':=', '$kdownload'),
            (NULL , '$service', 'pfSense-Bandwidth-Max-Up', ':=', '$kupload'),
            (NULL , '$service', 'pfSense-Max-Total-Octets', ':=', '$kquota');";
            ...
            echo "<!-- main-heading -->
                      ...
                      <div>
                          ...
                          <!-- Error Page Info -->
                          <div>
                              <p>Service $service added successfully!</p>
                          </div>
                          <!--// Error Page Info -->
            ...
            else
            {
               ...
               echo "          <!-- main-heading -->
                         ...
                         <div>
                             ...
                             <!-- Error Page Info -->
                             <div>
                                 <p>Service $service that you are trying to add, already Exist.</p>
                             </div>
                             <!--// Error Page Info -->
